 ...
 * is for our 132 class to learn about Stacks. It is similar to (but different
...
public interface Stack<E> {
	...
	/**
	 * Returns the top element of the stack but doesn't pop it off. Comparable to
	 * the peek() method in java.util.Stack
	 * 
